...
class GeneratorPublishCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'generator:publish';
    ...
    {
        $apiVersion = config('generator.api_version', 'v1');
        $apiPrefix = config('generator.api_prefix', 'api');
    ...
    private function publishTestCases()
    {
        ...
        $testsPath = config('generator.path.api_test', base_path('tests/'));
