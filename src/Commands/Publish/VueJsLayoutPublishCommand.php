...
class VueJsLayoutPublishCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'generator.publish:vuejs';
    ...
    private function copyView()
    {
        ...
        $resourcesPath = config('generator.path.resourcesPath', base_path('resources/'));
        $vendorPath = $resourcesPath.'assets/vendor/';
        $assetsJsPath = config('generator.path.assetsJsPath', base_path('resources/assets/js/'));
        $assetsCssPath = config('generator.path.assetsCssPath', base_path('resources/assets/css/'));
        $templateType = config('generator.templates', 'core-templates');
        $requestPath = config('generator.path.api_request', base_path('app/Http/Requests/'));
        ...
        foreach ($baseRequestCustomFiles as $stub => $php) {
            $sourceFile = base_path('vendor/germey/generator/templates/'.$stub);
        ...
        $sourceFile = base_path('vendor/germey/generator/templates/vuejs/js/gulpfile.js');
        $destinationFile = base_path().'/gulpfile.js';
        $this->publishFile($sourceFile, $destinationFile, 'gulpfile.js');

        $sourceFile = base_path('vendor/germey/generator/templates/vuejs/js/package.json');
