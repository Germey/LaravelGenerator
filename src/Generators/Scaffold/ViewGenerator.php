...
use Germey\Generator\Utils\GeneratorFieldsInputUtil;
use Germey\Generator\Utils\HTMLFieldGenerator;
...
class ViewGenerator extends BaseGenerator
{
    ...
    private function generateBladeTableBody()
    {
        ...
        $tableBodyFields = implode(generator_nl_tab(1, 3), $tableBodyFields);
    ...
    private function generateTableHeaderFields()
    {
        ...
        return implode(generator_nl_tab(1, 2), $headerFields);
    }
